...
| --- | --- |
| Fecha | 2026-09-19 |
| Estado | S0–S7 completados (2026-09-20) |
...
| S7 | Eliminar shims y carpeta `sim_to_fastpm/` | Alto | S1–S6 + CI verde | ✅ 2026-09-20 |
...
| 2026-09-20 | S7 completado (eliminados `sim_to_fastpm/`, `halo_catalog/`, `density_field/`, `halo_environment_descriptors/`, `tidal_tensor.py`; `pipelines/run_defaults.py`, `preprocessing/catalog_loaders.py`, `read_data/particles/`) |
